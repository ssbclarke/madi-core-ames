...
import { GAPS_PROMPT } from "./gaps.prompt.js";
...
export const GapTool = new DynamicTool({
    name: "gaps",
    description: "useful for describing the gaps, limits, whitespace, or needs of the existing research data.  This tool should be chosen if the user wants to know which categories, subcategories, investigations, topics, ilities, or needs have enough research. The input should be the exact QUESTION directly from the human user.",
