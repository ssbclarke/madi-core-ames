            ...
            <div className="flex h-full overflow-hidden flex-col min-w-min w-4/5 border-t border-base-300">  
                <div className="min-h-14 bg-base-200 shrink-0 ">
                    <div className="flex m-5 mb-2 justify-between">
                        <div className="flex flex-nowrap">
                            <div className="btn-group min-w-max">
                                <button className="rounded btn btn-sm btn-disabled	">
                            ...
                            <div className="btn-group ml-5 flex-nowrap">
                                <button className={`rounded btn btn-sm ${tagAnyAllStore==="any"?'btn-active':''}    btn-outline btn-primary text-primary-content`} onClick={()=>setTagAnyAllStore('any')}>Any</button>
                                <button className={`rounded btn btn-sm ${tagAnyAllStore==="all"?'btn-active':''}    btn-outline btn-primary text-primary-content`} onClick={()=>setTagAnyAllStore('all')}>All</button>
                                <button className={`rounded btn btn-sm ${tagAnyAllStore==="smart"?'btn-active':''}  btn-outline btn-primary text-primary-content`} onClick={()=>setTagAnyAllStore('smart')}>SmartMix</button>
                            </div>
                            {/* <button className={`w-9 rounded btn btn-sm ml-5 btn-square btn-outline btn-primary text-primary-content`}>
                                <svg className="h-4 w-5" stroke="currentColor"  fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"><path d="M160 32V64H288V32C288 14.33 302.3 0 320 0C337.7 0 352 14.33 352 32V64H400C426.5 64 448 85.49 448 112V160H0V112C0 85.49 21.49 64 48 64H96V32C96 14.33 110.3 0 128 0C145.7 0 160 14.33 160 32zM0 192H448V464C448 490.5 426.5 512 400 512H48C21.49 512 0 490.5 0 464V192zM80 256C71.16 256 64 263.2 64 272V368C64 376.8 71.16 384 80 384H176C184.8 384 192 376.8 192 368V272C192 263.2 184.8 256 176 256H80z"/></svg>
                            </button> */}
                            <button className={`w-9 rounded btn btn-sm ml-5 btn-square btn-primary
                                ${tagBookmarkStore?'text-primary-content':'btn-outline'} 
                            `} onClick={()=>setTagBookmarkStore(!tagBookmarkStore)} >
                                <svg className="h-4 w-5" stroke="currentColor" fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512"><path d="M384 48V512l-192-112L0 512V48C0 21.5 21.5 0 48 0h288C362.5 0 384 21.5 384 48z"/></svg>
                            </button>
                            <button className="rounded btn btn-sm ml-2 btn-link btn-primary"
                                onClick={clearTags}
                            >Clear All</button>
                        </div>
                        ...
                        <label htmlFor="tag-filter-toggle" className="drawer-button rounded btn btn-sm ml-5 btn-link btn-primary px-0 mx-0">
                ...
                <div style={{height:"calc(100% - 14rem)"}} // minus height of the settings above
                    ...
                    <div className="flex-col h-full flex ml-5">
                        <div className="font-semibold text-sm pb-1 pl-2 text-primary">Topic Areas</div>
                        <TagBox
                            options={topics}
                            optionGroup="topic"
                            ...
                            color="primary"
                        />
                        <div className="font-semibold text-sm pb-1 pl-2 text-accent">Ilities</div>
                        <TagBox
                            options={ilities}
                            selected={tagFilterStore.ility}
                            optionGroup="ility"
                            setValue={handleChange}
                            className="mb-5 overflow-y-scroll shrink-0 max-h-40"
                            color="accent"
                        />
                        <div className="mb-5 flex-1 overflow-hidden">
                            <div className="font-semibold text-sm pb-1 pl-2 text-info">Needs</div>
                            <TagBox
                                options={needs}
                    ...
                    <div className="flex-col h-full flex ml-5">
                        <div className="font-semibold text-sm pb-1 pl-2 text-warning">Categories</div>
                        <TagBox
                            options={categories}
                    ...
                    <div className="flex-col h-full flex ml-5">
                        <div className="font-semibold text-sm pb-1 pl-2 text-error">SubCategories</div>
                        <TagBox
