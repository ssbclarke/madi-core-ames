"use strict";
const { TAKEAWAY, PROBLEM, TREND, SOLUTION, QUOTE, ACTOR, NONE, COLOR_TAKEAWAY, COLOR_PROBLEM, COLOR_TREND, COLOR_SOLUTION, COLOR_QUOTE, COLOR_ACTOR, CONST_ARRAY } = require('./constants');
function populateMadiTypeField(widget) {
    var _a;
    // let newWidget = {}
    ...
    switch (true) {
        ...
        default:
            ...
            let color = ((_a = widget.style) === null || _a === void 0 ? void 0 : _a.backgroundColor) || null;
            switch (color) {
                case COLOR_TAKEAWAY:
                    ++guessMatrix[0];
                    break;
