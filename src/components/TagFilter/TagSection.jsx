                    ...
                    <div className="flex m-5 mb-2 justify-between">
                        <div className="flex flex-nowrap">
                            <div className="btn-group min-w-max">
                                <button className="rounded btn btn-sm btn-active btn-outline btn-primary ">
                                ...
                                <button className="rounded btn btn-sm btn-outline btn-primary">
                            ...
                            <div className="btn-group ml-5 flex-nowrap">
                                <button className="rounded btn btn-sm btn-active btn-outline btn-primary text-primary-content">Any</button>
                                <button className="rounded btn btn-sm btn-outline btn-primary  text-primary-content">All</button>
                                <button className="rounded btn btn-sm btn-outline btn-primary  text-primary-content">SmartMix</button>
                            </div>
                            <button className="w-9 rounded btn btn-sm ml-5 btn-square btn-outline btn-primary">
